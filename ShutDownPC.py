...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.in_radioButton.setText('Turn Off in')
        ...
        self.at_radioButton.setText('Turn Off after')
        ...
        self.setWindowIcon(QIcon('ShutDownPC_Icon.png'))
    ...
    def on_start_button(self):
        ...
        if shutdown_in < 300:
            reply = QMessageBox.question(self, 'Set a timer?',
                                         'You have entered a time less than 5 minutes, set the timer?',
        ...
        QMessageBox.information(self, 'The timer is set',
                                f'Your PC will shut down after {timedelta(seconds=shutdown_in)}!')

        self.start_button.setText('CANCEL')

    def on_cancel_button(self):
        os.system('shutdown -a')
        QMessageBox.information(self, 'Timer canceled',
                                'PC shutdown timer canceled, set a new one')
        self.start_button.setText('START')
